@if(isset($room))
    {!! Form::model($room, ['url' => "room/$room->id", 'method' => 'put', 'class' => 'form-horizontal']) !!}
@else
    {!! Form::open(['url' => 'room', 'method' => 'post', 'class' => 'form-horizontal']) !!}
@endif
<div class="form-group required {{ $errors->has('category_id') ? 'has-error' : '' }}">
    ...
    <div class="col-xs-9 col-sm-9">
    	<div class="col-xs-12 col-sm-12">
	        {!! Form::select('category_id', $categoryList, null, ['class' => 'form-control', 'placeholder' => 'Select Room Category']) !!}
